...
- Полноэкранный терминальный UI с графиком, логом выполнения и адаптивной версткой.
...
- При первом открытии UI выполняет автосинхронизацию по адресу из `.env` или сохраненному адресу.
